...
def test_app():
    ...
    with app.app_context():
        ...
        # --- Asymmetric 1 - Added in Apr. --- #
        from models.user import init_create_default_roles_and_permissions
